...
Significant decisions for **sdd-harness** itself. The copy-ready version of this index is `templates/adr-README.md`. Format: [MADR](https://adr.github.io/madr/).
...
| [0001](./0001-three-layer-instruction-model.md) | Three instruction layers, split by what a gate can catch | accepted |
